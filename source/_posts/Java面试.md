...
![jdk1.8之前的内部结构HashMap.jpg](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/08/27/15190f80-c87a-11e9-afb6-c9e9c0891586.jpg)

### JDK1.8之后

相比于之前的版本， JDK1.8之后在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为8）时，将链表转化为红黑树，以减少搜索时间。

![JDK1.8之后的HashMap底层数据结构.jpg](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/08/27/285efd70-c87a-11e9-afb6-c9e9c0891586.jpg)
...
![HashTable全表锁.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/08/27/41d71210-c87a-11e9-afb6-c9e9c0891586.png)

**JDK1.7的ConcurrentHashMap：**

![ConcurrentHashMap分段锁.jpg](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/08/27/517099d0-c87a-11e9-afb6-c9e9c0891586.jpg)

**JDK1.8的ConcurrentHashMap（TreeBin: 红黑二叉树节点 Node: 链表节点）：**

![JDK1.8ConcurrentHashMapStructure.jpg](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/08/27/5e87e380-c87a-11e9-afb6-c9e9c0891586.jpg)
...
- 实现 **java.io.Serializable接口** ，这意味着ArrayList **支持序列化** ， **能通过序列化去传输** 。
...
![win10任务管理器.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/08/27/e623b890-c88f-11e9-afb6-c9e9c0891586.png)
...
![运行时数据区域.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/d6114800-cf79-11e9-a36e-915d01a5fc8b.png)
...
![Java 线程的状态.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/b3191d60-cf7d-11e9-a36e-915d01a5fc8b.png)

线程在生命周期中并不是固定处于某一个状态而是随着代码的执行在不同状态之间切换。Java 线程状态变迁如下图所示
![Java 线程状态变迁.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/c28b4700-cf7d-11e9-a36e-915d01a5fc8b.png)
...
![RUNNABLE-VS-RUNNING.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/e6439080-cf7d-11e9-a36e-915d01a5fc8b.png)
...
> 死锁经典问题与解决请参考`哲学家就餐问题`

多个线程同时被阻塞，它们中的一个或者全部都在等待某个资源被释放。由于线程被无限期地阻塞，因此程序不可能正常终止。

如下图所示，线程 A 持有资源 2，线程 B 持有资源 1，他们同时都想申请对方的资源，所以这两个线程就会互相等待而进入死锁状态。

![死锁示例.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/17562020-cf7e-11e9-a36e-915d01a5fc8b.png)
...
`线程1`首先获得到 `resource1` 的监视器锁,这时候`线程2`就获取不到了。然后`线程1` 再去获取`resource2`的监视器锁，可以获取到。然后`线程1`释放了对`resource1`、`resource2`的监视器锁的占用，`线程2`获取到就可以执行了。这样就破坏了破坏循环等待条件，因此避免了死锁。
...
![synchronized关键字原理.png.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/852743d0-cf7f-11e9-a36e-915d01a5fc8b.png)
...
![synchronized关键字原理.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/45e78db0-cf7f-11e9-a36e-915d01a5fc8b.png)
...
![数据不一致.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/0e55ac50-cf80-11e9-a36e-915d01a5fc8b.png)

要解决这个问题，就需要把变量声明为**volatile**，这就指示 JVM，这个变量是不稳定的，每次使用它都到主存中进行读取。

说白了， **volatile** 关键字的主要作用就是保证变量的可见性然后还有一个作用是防止指令重排序。

![volatile关键字的可见性.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/252228f0-cf80-11e9-a36e-915d01a5fc8b.png)
...
![ThreadLocal内部类.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/711b5150-cf80-11e9-a36e-915d01a5fc8b.png)
...
**方式一：通过构造方法实现**
![ThreadPoolExecutor构造方法.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/9dac9e90-cf80-11e9-a36e-915d01a5fc8b.png)
...
![image.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/b3f67db0-cf80-11e9-a36e-915d01a5fc8b.png)
...
![JUC原子类概览.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/c90f2fd0-cf80-11e9-a36e-915d01a5fc8b.png)
...
![AQS类.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/fad0eb30-cf80-11e9-a36e-915d01a5fc8b.png)
...
![AQS原理图.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/174b9170-cf81-11e9-a36e-915d01a5fc8b.png)
...
![BlockingQueue 的实现类.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/bf07a1b0-cf81-11e9-a36e-915d01a5fc8b.png)
...
![2级索引跳表.png](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/d49360f0-cf81-11e9-a36e-915d01a5fc8b.png)

最低层的链表维护了跳表内所有的元素，每上面一层链表都是下面一层的子集。

跳表内的所有链表的元素都是排序的。查找时，可以从顶级链表开始找。一旦发现被查找的元素大于当前链表中的取值，就会转入下一层链表继续找。这也就是说在查找过程中，搜索是跳跃式的。如上图所示，在跳表中查找元素18。

![在跳表中查找元素18](https://newgr8player-blog.oss-cn-beijing.aliyuncs.com/hexo-client/2019/09/05/e52af7c0-cf81-11e9-a36e-915d01a5fc8b.png)
